...
| --- | --- |
| Build node plan | `local.nodes` in `modules/gcp-kubespray-cluster/main.tf` |
...
| Merge final results | Terraform outputs `control_plane_nodes`, `worker_nodes`, `all_nodes`, and `machine_plan` |
...
```powershell
terraform import "module.kubespray_cluster.google_compute_address.this[\"master01\"]" "projects/YOUR_PROJECT_ID/regions/asia-southeast1/addresses/k8s-master01-ip"
terraform import "module.kubespray_cluster.google_compute_instance.this[\"master01\"]" "projects/YOUR_PROJECT_ID/zones/asia-southeast1-a/instances/k8s-master01"
```
